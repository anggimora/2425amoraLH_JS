...
// movimiento-imagenes.js

// Selecciona todas las imágenes en la página
const imagenes = document.querySelectorAll('img');

// Añade un evento de mouseover y mouseout a cada imagen
imagenes.forEach(imagen => {
    imagen.addEventListener('mouseover', () => {
        // Mueve la imagen ligeramente hacia arriba y a la derecha
        imagen.style.transform = 'translate(-5px, -5px)'; // Ajusta los valores según sea necesario
        imagen.style.transition = 'transform 0.3s ease'; // Transición suave
    });
